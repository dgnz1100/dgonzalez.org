				...
				>
					...
					<div className="relative z-10">
						...
						<div className="font-mono">
							<p className="text-green-500 mb-2">ping contact --info</p>
							<h2 className="text-3xl font-bold mb-8 text-gray-200">Let&apos;s Connect</h2>
							<p className="text-green-500 mb-2">ping location --current</p>
							...
							<p className="text-green-500 mt-8 mb-2">ping contact --email</p>
							<motion.a
								href="mailto:digonzalez@icstars.org"
							...
							<p className="text-green-500 mt-8 mb-2">cat C:\Documents\Resume.pdf</p>
							<motion.a
								href="/resume.pdf"
								target="_blank"
							...
							<p className="text-green-500 mt-8 mb-4">ls C:\Documents\Social-Links</p>
							<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
								...
								>
									...
									<div>
										...
										<p className="text-sm text-gray-400">@dgnz1100</p>
									</div>
								</motion.a>
								<motion.a
								...
								>
									...
									<div>
										...
										<p className="text-sm text-gray-400">Diego Gonzalez</p>
									</div>
								</motion.a>
								<motion.a
												...
												>
													...
													<div>
														<p className="font-semibold text-gray-200">Substack</p>
														<p className="text-sm text-gray-400">dgnz1100</p>
													</div>
								</motion.a>
							</div>
